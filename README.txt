...
2. Set up a new ConnectionString in the appsettings.json. You will need your device name as data source, the DB-Name as catalog and your user credentials (ID and Password).
